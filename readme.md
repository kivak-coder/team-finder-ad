...
Для быстрой проверки функционала (отклики на проекты, работа избранного, фильтры пользователей) вы можете авторизоваться под следующими готовыми аккаунтами: (при входе вводить почту и пароль - 2 и 3 колонки)

| Имя и Фамилия | Email (Логин) | Пароль |
|---|---|---|
| Вики Кик | vikikik@mail.ru | vikikik |
| Иван Иванов | ivan@mail.ru | ivan |
| abob abobov | abob@mail.ru | abob |
| Фродо Беггинс | shire@mail.ru | frogo |
| Гендальф Серый | wizard@mail.ru | wizard |
...
| **ALLOWED_HOST**      |  Список разрешенных сетевых адресов   |
...
[Мой профиль на GitHub](https://github.com/kivak-coder)
